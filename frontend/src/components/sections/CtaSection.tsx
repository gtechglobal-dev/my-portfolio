    ...
    <section className="pb-28 md:pb-36">
      <div className="container px-6 md:px-8">
        ...
        >
          ...
          <p className="mt-3 md:mt-4 text-[0.9375rem] md:text-base text-[#a196b8] max-w-sm mx-auto leading-relaxed">
          ...
          <div className="mt-8 md:mt-10 flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link to="/booking" className="btn btn-accent w-full sm:w-auto">Book Your Call</Link>
