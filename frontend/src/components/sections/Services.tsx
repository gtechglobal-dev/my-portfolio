    ...
    <section id="our-services" className="py-24 md:py-28 scroll-mt-20">
      <div className="container px-6 md:px-8">
        <div className="text-center max-w-xl mx-auto mb-14 md:mb-16">
          ...
          <p className="mt-3 text-[0.9375rem] md:text-base text-muted">
                ...
                <div className="card overflow-hidden">
                  <button onClick={() => toggle(pkg.id)}
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-muted mt-1">{pkg.desc}</p>
                      ...
                      <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }}
                        ...
                        <div className="px-6 md:px-7 pb-6 md:pb-7 border-t border-white/[0.06] pt-5">
                          <div className="grid md:grid-cols-2 gap-6">
                            <div>
                              <h5 className="text-xs font-semibold uppercase tracking-wider text-faint mb-2">Perfect for</h5>
                            ...
                            <div>
                              <h5 className="text-xs font-semibold uppercase tracking-wider text-faint mb-2">Includes</h5>
                        ...
                        <div className="mb-3">
                          {pkg.id === 'other' ? (
                            ...
                            <>
                              ...
                              <div className="text-xs text-faint">${pkg.priceUsd} USD</div>
                            </>
                          )}
                        </div>
