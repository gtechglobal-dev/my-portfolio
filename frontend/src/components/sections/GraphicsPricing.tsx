    ...
    <section className="pb-20 md:pb-24">
      <div className="container px-6 md:px-8">
        <div className="text-center max-w-xl mx-auto mb-12 md:mb-14">
          ...
          <p className="mt-3 text-[0.9375rem] md:text-base text-muted">Professional design services at affordable rates.</p>
              ...
              <div className="mb-4">
                {pkg.id === 'other' ? (
                  ...
                  <>
                    ...
                    <div className="text-[10px] text-faint">${pkg.priceUsd} USD</div>
                  </>
                )}
              </div>
