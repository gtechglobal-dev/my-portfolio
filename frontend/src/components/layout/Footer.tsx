...
export default function Footer() {
  return (
    <footer className="border-t border-white/[0.04] bg-ink">
      <div className="container px-6 md:px-8 py-10 md:py-12">
        ...
        <div className="mt-6 pt-5 border-t border-white/[0.04] flex flex-col items-center gap-3 text-xs text-faint">
